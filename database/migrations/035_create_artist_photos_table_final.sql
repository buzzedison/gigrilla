...
DROP POLICY IF EXISTS "Users can view their own photos" ON artist_photos;
DROP POLICY IF EXISTS "Users can insert their own photos" ON artist_photos;
DROP POLICY IF EXISTS "Users can update their own photos" ON artist_photos;
DROP POLICY IF EXISTS "Users can delete their own photos" ON artist_photos;
